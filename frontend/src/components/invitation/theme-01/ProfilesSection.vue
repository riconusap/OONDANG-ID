...
const groomName = computed(() => props.invitation?.customTexts?.groomName || authStore.profile?.groom_name || 'Deni');
const groomFullName = computed(() => props.invitation?.customTexts?.groomFullName || authStore.profile?.groom_name?.toUpperCase() || 'DENI NURSALAM');
...
const brideName = computed(() => props.invitation?.customTexts?.brideName || authStore.profile?.bride_name || 'Sofiah');
const brideFullName = computed(() => props.invitation?.customTexts?.brideFullName || authStore.profile?.bride_name?.toUpperCase() || 'SOFIAH RAMADHANI');
