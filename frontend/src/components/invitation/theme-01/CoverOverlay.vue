...
<template>
  <div 
    id="cover-overlay" 
    :class="[
      'fixed inset-0 z-50 flex flex-col justify-end items-center pb-20 bg-wedding-dark bg-cover bg-center w-full max-w-[480px] mx-auto origin-bottom transition-transform duration-1000 ease-[cubic-bezier(0.645,0.045,0.355,1)]',
